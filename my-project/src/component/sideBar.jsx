      ...
      <aside id="default-sidebar" class="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full transition-transform sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            ...
            <ul id="dropdown-example" className={`py-2 space-y-2    ${isDropdownOpen ? '' : 'hidden'}`} class="hidden py-2 space-y-2 " >
                  <li>
                     <NavLink to='/usertable' class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">User</NavLink>
                  </li>
                  <li>
                     <NavLink to='/artisttable' class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Artist</NavLink>
                  </li>
                  <li>
                     <NavLink to='/admintable' class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Admin</NavLink>
                  </li>
            </ul>
         </li>
            <li>
