  ...
  return (
    ...
    <li>
        <NavLink to='/usertable' 
                 ...
                 className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">User</NavLink>
    </li>
    <li>
        <NavLink to='/artisttable' 
                 // onClick={() => handleItemClick('Artist')}
                 className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Artist</NavLink>
    </li>
    <li>
        <NavLink to='/admintable' 
                 // onClick={() => handleItemClick('Admin')}
                 className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Admin</NavLink>
    </li>
</ul>
         </li>
            <li>
