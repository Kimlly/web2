    ...
    return (
        <div class="max-w-lg p-6 bg-white border border-gray-200 rounded-2xl shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex -space-x-4 rtl:space-x-reverse ">
                ...
                <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src="https://scontent.fpnh5-5.fna.fbcdn.net/v/t39.30808-6/387020131_3537103346607054_7942417849146140981_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=9c7eae&_nc_eui2=AeEqgfXAO-A1tqzLrEPZH_q75YfdGsxrj4Plh90azGuPg0uL6uWsPeiKjKRsrg4vefADQG_odH9mqSLcTiv40Qjc&_nc_ohc=eUp5XwvKic4AX8D9OLi&_nc_ht=scontent.fpnh5-5.fna&oh=00_AfDlbPbXknJtYFJ2stNnyxhPTwhFYIQl6SJ7ys3EOUmV0A&oe=65A0EDB0" alt="" />
            ...
            <p class="mb-3 font-normal text-white dark:text-gray-400">Liked by sovathana_beksloy and others</p>
            ...
            <div class="flex items-center justify-center shadow-lg mt-4 max-w-lg">
                <form class="w-full max-w-xl bg-transparent rounded-lg px-4 pt-2">
                    ...
                    <div class="w-full flex items-start  px-3">
                        <div>
                            <input type='submit' class="bg-transparent text-white font-medium py-1 px-5 -m-3 mt-1 border border-gray-400 rounded-lg tracking-wide" value='Post Comment' />
                        </div>
                    </div>
                </form>
            </div>
