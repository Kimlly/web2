...
function Card({ data }) {
  ...
  return (
    <>
      <div className='max-w-lg p-6 bg-white border border-gray-200 rounded-2xl shadow dark:bg-gray-800 dark:border-gray-700'>
        <img className='h-auto max-w-full rounded-lg mb-3 ' src={data.imageURL} alt='' />
        <div className='flex items-center gap-4'>
          <img className='w-10 h-10 rounded-full' src={postOwner.pfImgURL} alt='' />
