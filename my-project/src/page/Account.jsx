                ...
                <div class='inline-block min-w-full overflow-hidden rounded-lg shadow'>
                  ...
                  <div class='xs:flex-row xs:justify-between flex flex-col items-center border-t bg-white px-5 py-5'>
                    ...
                    <div class='xs:mt-0 mt-2 inline-flex'>
                      <button class='rounded-l bg-indigo-600 px-4 py-2 text-sm font-semibold text-indigo-50 transition duration-150 hover:bg-indigo-500'>
                        Prev
                      </button>
                      &nbsp; &nbsp;
                      <button class='rounded-r bg-indigo-600 px-4 py-2 text-sm font-semibold text-indigo-50 transition duration-150 hover:bg-indigo-500'>
                        Next
                      </button>
                    </div>
                  </div>
